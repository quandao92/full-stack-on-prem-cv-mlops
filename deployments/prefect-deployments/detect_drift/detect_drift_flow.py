...
def detect_drift_flow(monitor_pool_name: str = "default-agent-pool",
                     model_metadata_file_path: str=variables.get('current_model_metadata_file'),#model_metadata_file_path="animals10_classifier_50px_demo.yaml", #model_metadata_file_path: str=variables.get('current_model_metadata_file'
